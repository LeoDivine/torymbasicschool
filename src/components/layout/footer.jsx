				...
				<div className='mt-6 md:mt-0'>
					<div className='flex flex-col md:flex-row items-center font-sans'>
						<input
							...
							className='text-black-800 sm:w-72 w-full sm:mr-5 mr-1 mb-4  py-2.5 rounded px-2 focus:outline-none'
						/>
						<button className='bg-pink-300 hover:bg-pink-500 duration-300 px-5 py-2.5 rounded-md text-white md:w-auto w-full md:mt-0 mt-2 '>
