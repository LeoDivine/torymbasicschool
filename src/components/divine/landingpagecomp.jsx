    ...
    <main>
      ...
      >
        ...
        <div className="relative text-white z-[4] text-center lg:text-left lg:w-[50%] px-5">
          ...
          <p className="md:text-[26px]">We cultivate intelligence and acedemic excellence</p>
      ...
      <div className="pt-[10px]">
        ...
        <div className="px-4  flex justify-around">
          <Carousel>
            {slides.map((s) => (
              <img className="object-cover" src={s}></img>
            ))}
          </Carousel>
          <p className="hidden lg:w-[60%] lg:inline">
            momifgfivifvnfivnfinvfivnfivnfvrbobjmtihy50ihnt tjo ttimobntj
            tjnijtnj ijnjtnutnonornhrhithjtohnth hnhtuhruhntrntj tjnhutnjntruht
            rthjtruhtr hjrt hutrn htr huth jtrh
